// ================================
// LEVRON PORTFOLIO - JAVASCRIPT (v5.1 — mobile scroll fix)
// ================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const openMenu = () => {
        // Guardar scroll actual en el style del body (fuente única de verdad)
    ...
    const closeMenu = (callback) => {
        // FIX CRÍTICO: leer la posición guardada en body.style.top
        // ANTES de limpiarla, para restaurar el scroll correctamente en iOS.
        // El orden importa: leer → limpiar top → quitar clase → scrollTo
        const savedTop  = document.body.style.top;
        const scrollTo  = savedTop ? -parseInt(savedTop, 10) : 0;

        document.body.style.top = '';
        document.body.classList.remove('menu-open');

        // scrollTo sin behavior:'instant' para máxima compatibilidad iOS/Android
    ...
    // ================================
    // PARALLAX ON PROJECT IMAGES (Desktop only)
    // ================================
    ...
    // ================================
    // PRISM LIGHTS FOLLOW MOUSE (Desktop only)
    // ================================
